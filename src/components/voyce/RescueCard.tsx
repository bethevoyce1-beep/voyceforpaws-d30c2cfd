        ...
        <article className="overflow-hidden rounded-3xl border border-border bg-card shadow-[0_8px_30px_-12px_rgba(60,40,10,0.12)]">
          ...
          <div className="px-5 pt-4">
            ...
            <div className="mt-3">
              ...
              {/* Reporter's correction summary — shown once they've added
                  something (the "Add what Voyce missed" pill lives in the row above). */}
              {hasMissed && (
                <div className="mt-2.5 rounded-2xl border border-[#F0C88A] bg-[#FFF9EC] px-3.5 py-2.5">
          ...
          <div className="mx-5 mt-5 mb-5 rounded-2xl bg-[#1A1611] px-4 py-4">
