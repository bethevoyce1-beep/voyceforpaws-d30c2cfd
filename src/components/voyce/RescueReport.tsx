    ...
    <div className="min-h-[100dvh] bg-background pb-32">
      ...
      <div className="mx-auto w-full max-w-2xl px-5 pt-4">
          ...
          <div className="mx-5 mt-4">
            ...
            <div className="mt-3 space-y-4">
              ...
              <div className="mt-4 space-y-4">
                ...
                <Section title="Summary — not a diagnosis">{data.vet_notes.clinical}</Section>
                <Section title="Suggested questions for a vet">
                  <ul className="space-y-1.5">
                ...
                {(data.differentials ?? []).length > 0 && (
                  <Section title="Possibilities for a vet to consider">
                    <ul className="space-y-1">
        ...
        <p className="mx-auto mt-3 max-w-xl text-center text-[12px] italic leading-relaxed text-muted-foreground">
          ⚠️ Voyce shares AI observations and suggestions, not veterinary advice or a diagnosis. AI may
          misidentify breed, age, or condition and cannot detect internal injuries, disease, parasites,
...
function AIHealthDisclaimer() {
  return (
    <div className="rounded-2xl border border-[#3A2A07] bg-[#1A1611] px-4 py-3.5">
      <div className="text-[11px] font-bold uppercase tracking-[0.14em] text-[#FFDF3B]">
        ⚠️ Voyce's First Look — Honest Limits
      </div>
      <p className="mt-2 text-[14px] leading-relaxed text-[#EDE3CE]">
        These are AI observations and suggestions — not veterinary advice, a diagnosis, or a treatment
        plan. Always confirm with a licensed veterinarian. This is generated by computer vision and may
        be inaccurate. AI cannot:
      </p>
      <ul className="mt-2 list-disc space-y-1 pl-5 text-[14px] leading-relaxed text-[#EDE3CE]">
      ...
      <p className="mt-2.5 text-[12.5px] italic leading-relaxed text-[#E8C97A]">
